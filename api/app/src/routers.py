...
from app.src.students_courses import routers as student_course_router
from app.src.courses import routers as course_router
from app.src.completion import routers as completion_router
...
router.include_router(completion_router.router)
